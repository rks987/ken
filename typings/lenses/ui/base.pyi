...
class BaseUiLens(Generic[S, T, A, B]):
    ...
    def Decode(self, encoding: str = ..., errors: str = ...) -> BaseUiLens[S, T, bytes, str]:
    ...
    def Error(self, exception: Exception, message: Optional[str] = ...) -> BaseUiLens[S, T, X, Y]:
    ...
    def Get(self, key: Any, default: Optional[Y] = ...) -> BaseUiLens[S, T, X, Y]:
    ...
    def Lens(self, getter: Callable[[A], X], setter: Callable[[A, Y], B]) -> BaseUiLens[S, T, X, Y]:
    ...
    def Iso(self, forwards: Callable[[A], X], backwards: Callable[[Y], B]) -> BaseUiLens[S, T, X, Y]:
    ...
    def Prism(self, unpack: Callable[[A], mJust[X]], pack: Callable[[Y], B], ignore_none: bool = ..., ignore_errors: Optional[tuple] = ...) -> BaseUiLens[S, T, X, Y]:
    ...
    def Traversal(self, folder: Callable[[A], Iterable[X]], builder: Callable[[A, Iterable[Y]], B]) -> BaseUiLens[S, T, X, Y]:
